...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(ulid: $ulid, name: $name, username: $username, avatar: $avatar, bio: $bio, website: $website, websiteName: $websiteName, background: $background, badges: $badges, followers: $followers, following: $following, friendCount: $friendCount, postCount: $postCount, videoCount: $videoCount, burstCount: $burstCount, emailVerified: $emailVerified, updatedAt: $updatedAt, updatedAtEpoch: $updatedAtEpoch, profileEngagement: $profileEngagement)';
  }
  ...
  int get hashCode => Object.hashAll([
        ...
        updatedAt,
        updatedAtEpoch,
        const DeepCollectionEquality().hash(_profileEngagement)
      ]);
